...
export const translations: Record<LanguageCode, TranslationDict> = {
  ko: {
    ...
    "cta.joinBeta": "무료 베타 신청하기",
    "cta.tryAppExperience": "AI 상담 정리 예시 보기",
    ...
    "landing.aiDemo.sectionTitle": "AI 상담 정리 예시 보기",
    "landing.aiDemo.sectionDesc":
      "상담 메모를 넣으면 고객 니즈, 문자 초안, 다음 연락 포인트가 어떻게 정리되는지 확인할 수 있습니다.",
    ...
    "landing.aiDemo.inputExample":
      "김민수 고객님은 GLC 조건과 월 납입 기준을 비교하고 싶어 하며, 다음 주 초 출고 가능 여부와 견적 조건 확인을 요청했습니다.",
    ...
    "landing.aiDemo.aiResponseExample":
      "GLC 조건, 월 납입 기준, 출고 가능 여부를 중심으로 다음 연락을 준비하면 좋습니다.",
    "landing.aiDemo.messageLabel": "추천 메시지",
    "landing.aiDemo.messageExample":
      "김민수 고객님, 오늘 상담 도와드린 담당자입니다.\n말씀 주신 GLC 조건과 월 납입 기준을 바탕으로 비교하시기 편하게 정리해드리겠습니다.\n다음 주 초에 출고 가능 여부와 견적 조건 확인해서 다시 안내드리겠습니다.\n궁금하신 부분은 편하게 말씀 주세요.",
    ...
    "landing.showroom.hero.headline": "상담은 했는데,\n다음 연락이 밀리고 있다면.",
    "landing.showroom.hero.headlineLine1": "상담은 했는데,",
    "landing.showroom.hero.headlineLine2": "다음 연락이 밀리고 있다면.",
    "landing.showroom.hero.sub":
      "Sensora는 자동차 영업사원이 상담 메모를 넣으면 고객 니즈, 문자 초안, 다음 연락 포인트까지 정리해주는 AI 영업 비서입니다.",
    "landing.showroom.hero.trustLine":
      "고객 정보는 자동으로 수집하지 않습니다. AI 결과는 사용자가 확인한 뒤 저장하고, 문자는 직접 복사해 발송합니다.",
    "landing.showroom.announcement.kicker": "초기 베타 영업사원 모집",
    "landing.showroom.announcement.body":
      "실제 자동차 영업 상담 메모를 기준으로 상담 정리, 문자 초안, 다음 연락 추천 기능을 함께 다듬습니다. 베타 기간에는 무료로 사용할 수 있으며, 자동 결제는 없습니다.",
    "landing.showroom.serviceMenu.sectionTitle": "상담 메모만 넣으면, 다음 행동까지 정리됩니다.",
    "landing.showroom.serviceMenu.sectionSub": "요약, 문자, 다음 연락 목적을 확인한 뒤 필요한 기록만 저장합니다.",
    "landing.showroom.serviceMenu.customersTitle": "고객관리",
    "landing.showroom.serviceMenu.customersDesc": "상담 메모와 관심 차량을 고객별로 다시 확인합니다.",
    "landing.showroom.serviceMenu.aiTitle": "AI 비서",
    "landing.showroom.serviceMenu.aiDesc": "고객 니즈, 문자 초안, 다음 연락 포인트를 제안합니다.",
    "landing.showroom.serviceMenu.aftercareTitle": "사후관리",
    "landing.showroom.serviceMenu.aftercareDesc": "다음 연락 목적과 타이밍을 놓치지 않도록 돕습니다.",
    "landing.showroom.serviceMenu.deliveryTitle": "출고 안내",
    "landing.showroom.serviceMenu.deliveryDesc": "출고 가능 여부와 안내 조건을 더 정확하게 준비합니다.",
    ...
    "landing.slides.home.nextCta": "해결 흐름 보기",
    "landing.slides.menu.kicker": "해결 흐름",
    "landing.slides.menu.nextCta": "운영 원칙 보기",
    "landing.slides.menu.enterpriseSub": "상담 메모가 실제 다음 행동으로 이어지는 방식을 확인하세요.",
    ...
    "landing.slides.enterprise.heroDefinition": "상담은 했는데, 다음 연락이 밀리고 있다면.",
    "landing.slides.enterprise.heroSub":
      "상담 메모를 넣으면 고객 니즈, 문자 초안, 다음 연락 포인트까지 정리합니다.",
    "landing.slides.philosophy.kicker": "신뢰 · 운영 원칙",
    "landing.slides.philosophy.title": "자동 저장도, 자동 발송도 없습니다.",
    "landing.slides.philosophy.line1": "고객 정보는 자동으로 수집하지 않습니다.",
    "landing.slides.philosophy.line2": "AI 결과는 사용자가 확인한 뒤 저장합니다.",
    "landing.slides.philosophy.line3": "문자는 직접 복사해 발송합니다.",
    "landing.slides.philosophy.line4": "최종 판단은 항상 영업사원이 합니다.",
    ...
    "landing.slides.actions.closingHeadline": "초기 베타 영업사원을 모집합니다.",
    "landing.slides.actions.browseAppCta": "AI 상담 정리 예시 보기",
    ...
    "landing.showroom.closing.title": "초기 베타 영업사원을 모집합니다.",
    "landing.showroom.bridge.line1": "상담 메모가",
    "landing.showroom.bridge.line2": "다음 연락으로 이어집니다.",
    ...
    "landing.showroom.flow.title": "상담 메모만 넣으면, 다음 행동까지 정리됩니다.",
    "landing.showroom.flow.desc":
      "고객 니즈 요약, 문자 초안, 다음 연락 목적 추천, 주의할 응대 포인트를 확인하고 필요한 고객 기록만 저장합니다.",
    "landing.showroom.flow.mock.contactTitle": "상담 메모 입력",
    "landing.showroom.flow.mock.contactBody": "GLC 조건 · 월 납입 기준 · 다음 주 초 출고 가능 여부 확인",
    "landing.showroom.flow.mock.needsTitle": "고객 니즈 요약",
    "landing.showroom.flow.mock.needsBody": "월 납입 기준 비교, 견적 조건, 출고 가능 여부가 핵심",
    "landing.showroom.flow.mock.smsTitle": "문자 초안 생성",
    "landing.showroom.flow.mock.smsBody":
      "김민수 고객님, 말씀 주신 GLC 조건과 월 납입 기준을 바탕으로 비교하시기 편하게 정리해드리겠습니다.",
    "landing.showroom.flow.mock.followupTitle": "다음 연락 목적 추천",
    "landing.showroom.flow.mock.followupBody": "다음 주 초 · 출고 가능 여부와 견적 조건 재안내",
    "landing.showroom.guide.title": "메모부터 문자 초안까지, 실제 연락에 바로 쓰기 쉽게.",
    "landing.showroom.guide.desc": "예시 안내입니다. 상담 메모가 고객 니즈, 문자 초안, 다음 연락 포인트로 정리되는 흐름을 확인할 수 있습니다.",
    ...
    "landing.showroom.features.title": "놓친 고객은 후속 연락에서 사라집니다",
    "landing.showroom.closing.desc": "베타 기간에는 무료로 사용할 수 있으며, 자동 결제는 없습니다.",
    ...
    "preview.toc.betaTitle": "무료 베타 신청하기",
    ...
    "preview.flow.step1.startCta": "AI 상담 정리 예시 보기",
    "preview.flow.step1.registerCta": "영업 계정 등록",
    "preview.flow.step2.headline": "상담 메모가 어떻게 정리되는지 확인하세요.",
    ...
    "preview.flow.step3.headline": "상담 메모만 넣으면, 다음 행동까지 정리됩니다.",
    "preview.flow.step3.sub":
    ...
    "guide.sensora-guide-03.title": "상담은 했는데, 다음 연락이 밀리고 있다면.",
    "guide.sensora-guide-03.desc": "상담 메모가 고객 니즈, 문자 초안, 다음 연락 포인트로 정리되는 흐름입니다.",
    "guide.sensora-guide-03.detailBody":
