...
export function SensoraGuideGallery({
  ...
  return (
    <div className="flex w-full min-w-0 flex-col gap-4 sm:gap-6 lg:gap-8">
      ...
      >
        ...
        <div className="relative px-3 pb-3 pt-3 sm:px-8 sm:pb-7 sm:pt-5 lg:px-10">
