...
type Props = {
  open: boolean;
  onClose: () => void;
  onGoLanding: (targetPath: "/?view=landing") => void;
 ...
 */
export function AppPreviewToc({ open, onClose, onGoLanding, onSelectSection, onOpenTargetPath }: Props) {
  const { t } = useLanguage();
  ...
  return (
    ...
    >
      ...
      <button
        ...
        onClick={() => onGoLanding("/?view=landing")}
