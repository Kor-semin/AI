          ...
          >
            <div className="landing-guide03-hero-shell mx-auto flex h-full w-full items-center justify-center">
              <div className="landing-guide03-hero-frame relative w-full max-w-[1440px] overflow-hidden">
                ...
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[0])} style={{ left: "27.1%", top: "65.9%", width: "15.5%", height: "15.1%", borderRadius: "16px" }} className="landing-guide03-hotspot landing-guide03-hotspot--tip-start" aria-label={`${LANDING_GUIDE_CARDS[0].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[0].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[1])} style={{ left: "43.9%", top: "65.9%", width: "15.5%", height: "15.1%", borderRadius: "16px" }} className="landing-guide03-hotspot landing-guide03-hotspot--tip-feature" aria-label={`${LANDING_GUIDE_CARDS[1].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[1].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[2])} style={{ left: "60.8%", top: "65.9%", width: "15.5%", height: "15.1%", borderRadius: "16px" }} className="landing-guide03-hotspot landing-guide03-hotspot--tip-flow" aria-label={`${LANDING_GUIDE_CARDS[2].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[2].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[3])} style={{ left: "77.6%", top: "65.9%", width: "15.5%", height: "15.1%", borderRadius: "16px" }} className="landing-guide03-hotspot landing-guide03-hotspot--tip-beta" aria-label={`${LANDING_GUIDE_CARDS[3].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[3].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[4])} style={{ left: "10.3%", top: "88.3%", width: "17.4%", height: "9.7%", borderRadius: "15px" }} className="landing-guide03-hotspot landing-guide03-hotspot--flow-memo" aria-label={`${LANDING_GUIDE_CARDS[4].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[4].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[5])} style={{ left: "31%", top: "88.3%", width: "17.4%", height: "9.7%", borderRadius: "15px" }} className="landing-guide03-hotspot landing-guide03-hotspot--flow-needs" aria-label={`${LANDING_GUIDE_CARDS[5].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[5].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[6])} style={{ left: "51.6%", top: "88.3%", width: "17.4%", height: "9.7%", borderRadius: "15px" }} className="landing-guide03-hotspot landing-guide03-hotspot--flow-sms" aria-label={`${LANDING_GUIDE_CARDS[6].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[6].title}</span>
                </button>
                <button type="button" onClick={() => setActiveGuideCard(LANDING_GUIDE_CARDS[7])} style={{ left: "72.3%", top: "88.3%", width: "19%", height: "9.7%", borderRadius: "15px" }} className="landing-guide03-hotspot landing-guide03-hotspot--flow-next" aria-label={`${LANDING_GUIDE_CARDS[7].title} · ${t("landing.showroom.concept.tapToExpand")}`}>
                  <span className="sr-only">{LANDING_GUIDE_CARDS[7].title}</span>
                </button>
              </div>
            </div>
          </div>
