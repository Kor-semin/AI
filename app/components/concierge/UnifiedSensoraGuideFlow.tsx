...
function AppPreviewScreenBrowser({
  ...
  const copy = ko
    ? {
        title: "AI 상담 정리 예시",
        sub: "상담 메모가 고객 니즈, 문자 초안, 다음 연락 포인트로 정리되는 흐름을 확인하세요.",
        eyebrow: "앱 화면 미리보기",
        cards: [
          {
            id: "customers",
            tone: "customers",
            title: "고객관리",
            desc: "상담 메모와 관심 차량을 고객별로 다시 확인합니다.",
            action: "고객관리 열기",
            kind: "section",
            section: "customers",
          ...
          },
          {
            ...
            tone: "ai",
            title: "AI 비서",
            desc: "니즈 요약, 문자 초안, 다음 연락 포인트를 제안합니다.",
            action: "AI 비서 열기",
            kind: "section",
            section: "ai",
          ...
          },
          {
            ...
            tone: "followup",
            title: "사후관리",
            desc: "다음 연락 목적과 확인 타이밍을 놓치지 않도록 돕습니다.",
            action: "사후관리 열기",
            kind: "section",
            section: "followup",
          ...
          },
          {
            ...
            tone: "delivery",
            title: "출고 안내",
            desc: "출고 가능 여부와 안내 조건을 더 정확하게 준비할 수 있도록 구성 중입니다.",
            action: "준비 중",
            kind: "delivery",
            points: ["안내 문구", "준비 항목"],
          },
