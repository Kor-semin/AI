...
function AppPreviewScreenBrowser({
  ...
  const copy = ko
    ? {
        ...
        sub: "고객관리, AI 비서, 사후관리 흐름을 카드별로 확인하고 바로 업무 화면으로 이동해보세요.",
        eyebrow: "앱 화면 미리보기",
        tabs: {
          all: "전체",
          customers: "고객관리",
        ...
        cards: [
          {
            ...
            tone: "customers",
            title: "고객관리",
            desc: "상담 메모, 관심 차량, 다음 연락 정보를 고객별로 확인합니다.",
            action: "고객관리 열기",
            kind: "section",
            section: "customers",
          ...
          },
          {
            ...
            tone: "ai",
            title: "AI 비서",
            desc: "상담 내용을 바탕으로 검토용 메시지 초안과 니즈 정리를 확인합니다.",
            action: "AI 비서 열기",
            kind: "section",
            section: "ai",
          ...
          },
          {
            ...
            tone: "followup",
            title: "사후관리",
            desc: "다음 연락, 해야 할 일, 사후관리 일정을 한 흐름으로 확인합니다.",
            action: "사후관리 열기",
            kind: "section",
            section: "followup",
