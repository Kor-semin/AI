            ...
            <button
              ...
              className={[
                ...
                selected && sameDay(selected, dt)
                  ...
                  : sameDay(new Date(), dt)
                    ? "border-white/[0.2] bg-white/[0.08] text-slate-100 hover:border-sky-400/32"
                    : "border-transparent bg-[#020817]/55 text-slate-200 hover:z-[1] hover:border-sky-400/26 hover:bg-[#07111f]/85",
              ].join(" ")}
            >
